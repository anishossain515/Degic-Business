...
function Presentation() {
  return (
    <section className="bg-[#f9f9f9] mt-[161px]">
      <div className="container flex lg:flex-row flex-col lg:items-start items-center py-[136px] gap-[110px] mx-w-[1400px] mx-auto">
        {/* left part */}
        ...
        {/* first part start*/}
         ...
         <div className="lg:pt-[180px] sm:pt-32 pt-20 ">
